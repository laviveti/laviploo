    ...
    <div className='flex-1 overflow-hidden'>
      <div className='h-full bg-zinc-50 p-6'>
        ...
        <div className='mb-6'>
          ...
          <p className='text-zinc-600'>Visão geral das suas integrações e automações do Ploomes</p>
        </div>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3 mb-6'>
          ...
          <Card className='rounded-md hover:shadow-md transition-shadow'>
            <CardHeader className='pb-2 px-3 py-3'>
              <div className='flex items-center justify-between'>
                <CardTitle className='text-sm font-medium text-zinc-600'>Integrações</CardTitle>
                <Zap className='h-4 w-4 text-rose-500' />
              </div>
            </CardHeader>
            <CardContent className='px-3 pb-3'>
              <div className='text-2xl font-bold text-zinc-800'>{integrationStats?.connectedIntegrations || 0}</div>
              <p className='text-xs text-zinc-500'>de {integrationStats?.totalIntegrations || 0} disponíveis</p>
            </CardContent>
          </Card>
          ...
          <Card className='rounded-md hover:shadow-md transition-shadow'>
            <CardHeader className='pb-2 px-3 py-3'>
              <div className='flex items-center justify-between'>
                <CardTitle className='text-sm font-medium text-zinc-600'>Automações</CardTitle>
                <Bot className='h-4 w-4 text-purple-500' />
              </div>
            </CardHeader>
            <CardContent className='px-3 pb-3'>
              <div className='text-2xl font-bold text-zinc-800'>{automationStats?.activeAutomations || 0}</div>
              <p className='text-xs text-zinc-500'>de {automationStats?.totalAutomations || 0} criadas</p>
            </CardContent>
          </Card>
          ...
          <Card className='rounded-md hover:shadow-md transition-shadow'>
            <CardHeader className='pb-2 px-3 py-3'>
              <div className='flex items-center justify-between'>
                <CardTitle className='text-sm font-medium text-zinc-600'>Comportamentos</CardTitle>
                <Activity className='h-4 w-4 text-blue-500' />
              </div>
            </CardHeader>
            <CardContent className='px-3 pb-3'>
              <div className='text-2xl font-bold text-zinc-800'>{automationStats?.totalBehaviors || 0}</div>
              <p className='text-xs text-zinc-500'>de integrações</p>
            </CardContent>
          </Card>
          ...
          <Card className='rounded-md hover:shadow-md transition-shadow'>
            <CardHeader className='pb-2 px-3 py-3'>
              <div className='flex items-center justify-between'>
                <CardTitle className='text-sm font-medium text-zinc-600'>Status Geral</CardTitle>
            ...
            <CardContent className='px-3 pb-3'>
              ...
              <p className='text-xs text-zinc-500'>de disponibilidade</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
          ...
          <Card className='rounded-md hover:shadow-md transition-shadow'>
            ...
            <CardContent className='px-3 pb-3'>
              <p className='text-sm text-zinc-600 mb-3'>Explore todas as automações de funis, estágios, triggers e ações configuradas.</p>
