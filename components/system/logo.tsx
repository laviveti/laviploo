...
const LogoIcon = ({ className, size = "md", variant = "lavive", ...props }: LogoIconProps) => {
  return (
    <svg
      viewBox='-6 0 50 35'
      ...
      className={cn(iconSizeVariants[size], variantStyles[variant], "stroke-[4]", className)}
      {...props}>
      <path
...
const LogoFull = ({ className, size = "lg", iconVariant = "lavive", spacing = "none", ...props }: LogoFullProps) => {
  return (
