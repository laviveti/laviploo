...
import type { AutomationStats } from "@/types/automations";

interface AutomationStatsProps {
  stats: AutomationStats;
}

export const AutomationStatsComponent = ({ stats }: AutomationStatsProps) => {
  const statsData = [
    {
    ...
    {
      title: "Comportamentos Ativos",
      value: stats.activeBehaviors,
      color: "text-blue-600",
