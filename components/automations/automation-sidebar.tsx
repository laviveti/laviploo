      ...
      <div className='p-3 border-b border-zinc-100 space-y-1'>
        ...
        <button
          ...
          <div className='flex items-center justify-between'>
            ...
            {genericCount.total > 0 && (
              <Badge variant={selectedEntityId === null && selectedFilter === "generic" ? "default" : "secondary"} className='h-4 text-xs px-1'>
          ...
          {AUTOMATION_ENTITIES.map((entity) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "w-full text-left px-2 py-2 text-xs rounded-sm transition-colors",
                  isSelected && selectedFilter !== "generic" ? "bg-rose-50 text-rose-700 border border-rose-200" : "text-zinc-700 hover:bg-zinc-50"
                )}>
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-2'>
                  ...
                  <Badge variant={isSelected ? "default" : "secondary"} className='h-4 text-xs px-1'>
