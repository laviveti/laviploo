...
import type { IntegrationBehavior } from "@/types/automations";
...
export const BehaviorList = ({ behaviors }: BehaviorListProps) => {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg font-semibold text-zinc-800">
            Comportamentos de Automação
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="text-center py-8 text-zinc-500">
            Nenhum comportamento de automação encontrado
          </div>
        </CardContent>
      </Card>
    );
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-lg font-semibold text-zinc-800">
          Comportamentos de Automação ({behaviors.length})
        </CardTitle>
      </CardHeader>
      <CardContent>
        <Table>
